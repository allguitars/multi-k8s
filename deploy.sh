docker build -t allguitars/multi-client:latest -t allguitars/multi-client:$SHA -f ./client/Dockerfile .
docker build -t allguitars/multi-server:latest -t allguitars/multi-server:$SHA -f ./server/Dockerfile .
docker build -t allguitars/multi-worker:latest -t alltuitars/multi-worker:$SHA -f ./worker/Dockerfile .
